...
class TestMetrics:
    ...
    def test_smooth_images_demand_a_higher_floor(self):
...
class TestLoadPil:
    def test_soft_mask_is_not_composited_into_alpha(self, smask_pdf):
